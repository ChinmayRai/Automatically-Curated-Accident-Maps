...
infile="article_openie_output.txt"
txtCasualtyClause="sent_selected_casualty.txt"
jsonCasualtyClause="sent_selected_casualty.json"
txtCasualtyNum="num_casualty.txt"
jsonCasualtyNum="num_casualty.json"
